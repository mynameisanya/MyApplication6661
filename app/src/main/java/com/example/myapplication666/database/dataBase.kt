...
@Database(entities = [DiaryModel::class, DataExercise::class, DataExercise2::class], version = 2, exportSchema = false)
//перечисляются все конвертеры, которые используются бд
@TypeConverters(DiaryModelTypeConverter::class, ExerciseTypeConverter::class, ExerciseTypeConverter2::class)
